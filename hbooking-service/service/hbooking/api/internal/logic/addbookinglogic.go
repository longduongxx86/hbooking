...
type AddBookingLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewAddBookingLogic(ctx context.Context, svcCtx *svc.ServiceContext) *AddBookingLogic {
	return &AddBookingLogic{
...
func (l *AddBookingLogic) AddBooking(req *types.AddBookingReq) (resp *types.AddBookingRes, err error) {

	l.Logger.Infof("AddBooking: %v", req)
	...
	booking = &model.Bookings{
		BookingId:    l.svcCtx.ObjSync.GenServiceObjID(common.ENTITY_TYPE_ROOM),
	...
	if err = l.svcCtx.BookingsModel.InsertDb(l.ctx, booking); err != nil {
		l.Logger.Error(err)
		return &types.AddBookingRes{
			Code:    common.DB_ERR_CODE,
			Message: common.DB_ERR_MESS,
	...
	resp = &types.AddBookingRes{
		Code:    common.SUCCESS_CODE,
		Message: common.SUCCESS_MESS,
		Data: types.AddBookingData{
	...
	l.Logger.Infof("AddBooking success: %v", booking)
	return resp, nil
}
